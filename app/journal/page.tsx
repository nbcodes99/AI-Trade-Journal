...
import { ArrowUpIcon, FilePlusCorner, X } from "lucide-react";
...
export default function Journal() {
  ...
  return (
    <section className="flex flex-col items-center w-full max-w-4xl mx-auto px-2 mt-6">
      <h1 className="text-3xl font-bold mb-4">Journal Your Trade</h1>
      <p className="max-w-2xl text-sm text-muted-foreground mb-6 text-center">
        Use this page to log each trade entry, exit, setup, emotion, and market
        context. After journaling a trade, view the full list on the Trades
        page.
      </p>
          ...
          <div className="col-span-2">
            ...
            <div className="flex flex-wrap gap-2">
              {confluenceTags.map((tag, i) => (
                <span
                  key={i}
                  className="flex items-center bg-muted px-3 py-1 rounded-full text-sm text-foreground"
                >
                  {tag}
                  <button
                    type="button"
